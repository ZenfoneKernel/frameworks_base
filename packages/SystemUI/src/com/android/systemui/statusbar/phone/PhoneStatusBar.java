...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private int mBatterySaverWarningStyle;
    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BATTERY_SAVER_MODE_COLOR_STYLE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BATTERY_SAVER_MODE_CUSTOM_COLOR),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
        ...
        @Override
         public void onChange(boolean selfChange, Uri uri) {
            ...
            if (uri.equals(Settings.System.getUriFor(
                    Settings.System.BATTERY_SAVER_MODE_COLOR_STYLE))) {
                    mBatterySaverWarningStyle = Settings.System.getIntForUser(resolver,
                             Settings.System.BATTERY_SAVER_MODE_COLOR_STYLE, 0, UserHandle.USER_CURRENT);

                    switch (mBatterySaverWarningStyle) {
                        case 1: {
                            mBatterySaverWarningColor = Settings.System.getIntForUser(resolver,
                            ...
                            mBatterySaverWarningColor = 16777215;
                            break;
                        } default: {
                            mBatterySaverWarningColor = mContext.getResources()
                                    .getColor(com.android.internal.R.color.battery_saver_mode_color);
        ...
        public void update() {
            ...
            mClockLocation = Settings.System.getInt(resolver, Settings.System.STATUS_BAR_CLOCK, Clock.STYLE_CLOCK_RIGHT);
            updateClockView();
